...
def svm_train_and_evaluate(args, adj, y, indices, cc, p_values, cur_repeat):
    results_list = []
    ...
    for topk in args.topk_feature_list:
        ...
        if args.measure in ['sex', 'Autism','Gender','Parkinson']:
            ...
            param_combinations = [{'C': 1, 'kernel': 'linear', 'probability':True, 'random_state':42},
            ...
            param_combinations = [{'C': 1, 'kernel': 'linear'}, 
