...
class Brainnetcnn_Train:
    ...
    def save_trained_model(self, model_dict, is_explain):
        save_model_file = f'/local/scratch3/khan58/BrainNetworkTransformer/testrun/new_save/trained_models/model_{self.config.common_save}_isexplain{is_explain}_repeat{self.config.dataset.cur_repeat}.pth'
