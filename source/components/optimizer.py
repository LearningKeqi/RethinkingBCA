...
def optimizer_factory(model: torch.nn.Module, optimizer_config: DictConfig) -> torch.optim.Optimizer:
    ...
    if optimizer_type == 'SGD':
        ...
        # parameters['nesterov'] = optimizer_config.nesterov  # I annotate this 
        if optimizer_config.weight_decay != 0:
            parameters['weight_decay'] = optimizer_config.weight_decay
        else:
            parameters['weight_decay'] = optimizer_config.alpha * (1 - optimizer_config.l1_ratio)
