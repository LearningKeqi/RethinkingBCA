...
def random_forest_train_and_evaluate(args, adj, y, indices, cc, p_values, cur_repeat):
    results_list = []
    ...
    for topk in args.topk_feature_list:
        ...
        if args.measure in ['sex', 'Autism','Gender','Parkinson']:
            param_combinations = [{'n_estimators': 100, 'max_depth': None},
            ...
            param_combinations = [{'n_estimators': 100, 'max_depth': None, 'max_features': 'sqrt'},
