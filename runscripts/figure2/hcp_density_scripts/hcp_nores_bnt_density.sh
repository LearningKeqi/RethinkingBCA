python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density0\
  ...
  tune_new_learning_rates=[[5.0e-5,5.0e-6]]\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density005\
  dataset.only_positive_corr=False\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density01\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density015\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density02\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density025\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density03\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density05\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density07\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  model.pooling=[False,True]\
  model.sizes=[132,64] model.dim_reduction=False\
  exp_name=HCP_nores_bnt_density1\
  dataset.only_positive_corr=False\
