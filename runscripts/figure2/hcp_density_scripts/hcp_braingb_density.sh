...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density005\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density01\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density015\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density02\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density025\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density03\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density05\
  dataset.only_positive_corr=False\
...
python -u -m source --multirun datasz=100p model=braingb\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=braingb_hcp_density07\
  dataset.only_positive_corr=False\
