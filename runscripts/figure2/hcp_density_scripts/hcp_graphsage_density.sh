python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  exp_name=graphsage_hcp_density0\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density005\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density01\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density015\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density02\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density025\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density03\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density05\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density07\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=PMAT24_A_CR\
  dataset.node_feature_type=connection\
  exp_name=graphsage_hcp_density1\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
