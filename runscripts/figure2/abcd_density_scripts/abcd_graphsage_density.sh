python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  exp_name=ABCD_graphsage_density0\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density005\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density01\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density015\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density02\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density025\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density03\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density05\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density07\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=mixed_model\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=ABCD_graphsage_density1\
  model.one_layer_fc=True\
  dataset.only_positive_corr=True\
