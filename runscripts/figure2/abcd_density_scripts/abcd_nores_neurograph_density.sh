python -u -m source --multirun datasz=100p model=neurograph\
  ...
  exp_name=nores_neurograph_abcd_density0\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density005\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density01\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density015\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density02\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density025\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density03\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density05\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density07\
  dataset.only_positive_corr=True\
...
python -u -m source --multirun datasz=100p model=neurograph\
  ...
  dataset.measure=pea_wiscv_trs\
  dataset.node_feature_type=connection\
  exp_name=nores_neurograph_abcd_density1\
  dataset.only_positive_corr=True\
